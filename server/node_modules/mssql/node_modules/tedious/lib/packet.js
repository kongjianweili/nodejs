...
Packet = (function () {
  ...
  Packet.prototype.dataToString = function (indent) {
    var BYTES_PER_GROUP, BYTES_PER_LINE, CHARS_PER_GROUP, chars, data, dataDump, i, offset, ref;
    ...
    dataDump = '';
    chars = '';
    for (offset = i = 0, ref = data.length - 1; 0 <= ref ? i <= ref : i >= ref; offset = 0 <= ref ? ++i : --i) {
