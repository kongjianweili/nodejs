...
var EPOCH_DATE, MAX, NULL, TYPE, UTC_EPOCH_DATE, UTC_YEAR_ONE, YEAR_ONE, alias, guidParser, i, id, len, ref, type, typeByName;
...
TYPE = {
  ...
  0xF3: {
    ...
    writeTypeInfo: function (buffer, parameter) {
      ...
      return buffer.writeBVarchar((ref2 = (ref3 = parameter.value) != null ? ref3.name : void 0) != null ? ref2 : "");
    },
    writeParameterData: function (buffer, parameter, options) {
      var column, i, index, j, k, len, len1, len2, param, ref, ref1, row, value;
      if (parameter.value == null) {
      ...
      buffer.writeUInt8(0x00);
      ref1 = parameter.value.rows;
      for (j = 0, len1 = ref1.length; j < len1; j++) {
        row = ref1[j];
        buffer.writeUInt8(0x01);
        for (index = k = 0, len2 = row.length; k < len2; index = ++k) {
          value = row[index];
          param = {
            value: value,
